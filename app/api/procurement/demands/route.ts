...
export async function GET(request: NextRequest) {
  try {
    ...
    return errorResponse('INTERNAL_ERROR', error.message || 'Failed to fetch demands', null, 500)
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('INTERNAL_ERROR', error.message || 'Failed to create demand', null, 500)
  }
}
