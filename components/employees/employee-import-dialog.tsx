    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload an Excel file to import multiple employees at once. Download the template to get started.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
                  ...
                  <TableBody>
                    {importResult.errors.map((error: any, index: number) => (
                      <TableRow key={index}>
                        ...
                        <TableCell className="font-mono text-sm">{error.employeeId}</TableCell>
          ...
          {/* Success List */}
          {importResult && importResult.successfulEmployees && importResult.successfulEmployees.length > 0 && (
            <div className="space-y-2">
              <h3 className="font-semibold text-green-600">Successfully Imported Employees</h3>
              <div className="border rounded-lg max-h-60 overflow-y-auto">
                <Table>
                  <TableHeader>
                    <TableRow>
                  ...
                  <TableBody>
                    {importResult.successfulEmployees.map((employee: any) => (
          ...
          <Alert>
            ...
            <AlertDescription className="text-sm space-y-1">
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>Department and Shift codes must exist in the system</li>
