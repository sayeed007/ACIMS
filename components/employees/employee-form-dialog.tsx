...
export function EmployeeFormDialog({
  ...
  const onSubmit = async (data: CreateEmployeeData) => {
    ...
    try {
      if (mode === 'create') {
        // Exclude employeeId for create (backend will auto-generate)
        const { employeeId, ...createData } = data;
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                disabled
                className="bg-muted"
                value={mode === 'edit' ? employee?.employeeId : ''}
                readOnly
              />
              <p className="text-xs text-muted-foreground">
                ℹ️ Employee ID will be automatically generated by the system
              </p>
            </div>
